...
exports.default = function (opt) {
  ...
  registrationSource.migrate().then(function () {
    return router.post("/", function (req, res, next) {
      _log4js2.default.getLogger("sms").info("Incomming request", req.body);
      ...
      registrationSource.getRegistrationsByPhone(phone).then(function (registrations) {
        ...
        if (pendingRegistrations.length > 0) {
          ...
          if (pending.state == _registrationState2.default.ASKED_PARTY) {
            (0, _events.getCaseParties)(pending.case_number).then(function (parties) {
              var matching;
              ...
              if (matching) {
                ...
                (0, _twilio.sendMessage)(messageSource.askPartyAgain(text, phone, registration, parties));
              }
            });
          ...
          registrationSource.createRegistration({
            ...
            return (0, _events.getCaseParties)(text).then(function (parties) {
