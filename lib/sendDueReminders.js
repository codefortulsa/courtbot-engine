...
exports.default = function (opt) {
  ...
  return registrationSource.getRegistrationsByState(_registrationState.registrationState.REMINDING).then(function (registrations) {
    if (registrations.length == 0) {
      console.log("No records to process.");
      return;
    }
    return Promise.all(registrations.map(function (r) {
      return options.caseData.getCasePartyEvents(r.casenumber, r.name).then(function (events) {
